...
const Register = () => {
    const { setPassword,setNumber,Login,number,setlastName,setfirstName,
  ...
  return (
    <div className='auth'>
        <div className='container'>
            ...
            <div className='inputs'>
            <label htmlFor="lastName"><i class="fa-solid fa-user"></i></label>
      ...
      />
            ...
            <input type="notinonality" id='notinonality'  placeholder="notinonality" onChange={(e) => {setNotinonality(e.target.value)}} />
            </div>
            <div className='inputs'>
